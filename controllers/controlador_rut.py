...
class ControladorRut:
    ...
    def procesar_rut(self, rut_texto: str):
        ...
        if not exito:
            ...
            # FIX: limpiar pestañas Variable v y Ecuación
            self.vista.mostrar_variable_v("── Variable auxiliar v ──\nIngrese un RUT válido para continuar.")
            self.vista.mostrar_ecuacion("── Construcción de la Ecuación General ──\nIngrese un RUT válido para continuar.")
